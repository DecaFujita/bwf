...
from .models import Event, Group, User, UserProfile
from api.serializers import EventSerializer, GroupSerializer, GroupFullSerializer, UserSerializer, UserProfileSerializer, ChangePasswordSerializer
...
class GroupViewset(viewsets.ModelViewSet):
    ...
    # TO DISPLAY FULL CONTENT OF THE MODEL
